...
function carregarCardsRelatorios() {
    ...
    document.getElementById("totalRelatoriosExportados").textContent = relatorios.length;
    document.getElementById("lojasCriticasRelatorio").textContent = lojasCriticas.length;
    document.getElementById("totalEnviosRelatorio").textContent = envios.length;
    document.getElementById("totalRecebimentosRelatorio").textContent = recebimentos.length;
}
...
function exportarRelatorioEstoqueGeral() {
    ...
    const linhas = lojas.map(function(loja) {
...
function exportarRelatorioEstoqueCritico() {
    ...
    const linhas = lojasCriticas.map(function(loja) {
        return montarLinhaCsv([
            loja.codigo,
            loja.nome,
            obterEstoqueAtual(loja),
